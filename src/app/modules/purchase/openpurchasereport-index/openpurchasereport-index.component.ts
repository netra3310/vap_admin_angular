...
export class OpenpurchasereportIndexComponent implements OnInit, OnDestroy {
  ...
  initialColumns : any = ['SuppierInvoiceNo', 'Supplier', 'dTotalPurchaseValue', 'CreatedAt', 'sRemarks'];  
  ...
  ngOnInit(): void {
    this.initPageNo = this.storageService.getItem('open_purchase_report_page_no');
    this.storageService.removeItem('open_purchase_report_page_no');
  ...
  emitAction(event : any) {
    this.storageService.setItem('open_purchase_report_page_no', (event.curPageNo - 1));
