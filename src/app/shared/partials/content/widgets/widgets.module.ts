...
import { SliderWidgetComponent } from './slider/slider-widget/slider-widget/slider-widget.component';
import { SliderWidget2Component } from './slider/slider-widget2/slider-widget2.component';
import { MixedWidgetNotificationsComponent } from './mixed/mixed-widget-notifications/mixed-widget-notifications.component';
@NgModule({
  declarations: [
    // Advanced Tables
